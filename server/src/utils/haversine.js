/**
 * Haversine Formula Utility to calculate exact distance in kilometers
 * between two geographic coordinates (latitude, longitude).
 * 
 * Formula:
...
/**
 * District coordinates lookup dictionary for AP & Telangana districts
 */
...
export const getCoordinatesForDistrict = (districtName) => {
  ...
  // Default coordinates (Guntur central reference)
  return { latitude: 16.3067, longitude: 80.4365 };
};
