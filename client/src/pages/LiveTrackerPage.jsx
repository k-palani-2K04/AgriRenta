...
export const LiveTrackerPage = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Top Header Banner (Light Cream Container Design) */}
      <div className="bg-[#FAF8F5] rounded-3xl border border-slate-200/90 p-6 sm:p-8 text-slate-900 shadow-xs relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <button
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-4 py-2.5 rounded-2xl text-xs shadow-xs transition-all flex items-center space-x-2 shrink-0 disabled:opacity-50 cursor-pointer"
          >
