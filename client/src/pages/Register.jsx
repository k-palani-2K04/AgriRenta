    ...
    <div className="min-h-[85vh] flex items-center justify-center py-6 px-4">
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/60 border border-slate-200/80 overflow-hidden backdrop-blur-sm">
          ...
          <div className="bg-gradient-to-br from-emerald-800 via-emerald-700 to-teal-900 p-8 text-white text-center relative overflow-hidden">
            <div className="absolute -right-8 -bottom-8 opacity-10 pointer-events-none">
              <Tractor className="w-48 h-48 text-white" />
            </div>

            <div className="inline-flex items-center space-x-2 bg-white/15 backdrop-blur-md px-3.5 py-1.5 rounded-full text-xs font-medium text-emerald-100 border border-white/20 mb-3 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <div className="flex items-center space-x-1.5">
                      ...
                      {role === 'provider' && <CheckCircle2 className="w-4 h-4 text-emerald-600" />}
                    </div>
              ...
              {role === 'provider' && (
                <div className="bg-emerald-50/70 border border-emerald-200 p-3.5 rounded-2xl space-y-1">
                  <label className="block text-xs font-extrabold text-emerald-950 flex items-center space-x-1.5">
                  ...
                  <div className="relative pt-1">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3.5 py-2.5 bg-white border border-emerald-200 rounded-2xl text-xs font-mono font-bold text-emerald-950 focus:outline-hidden focus:border-emerald-600 focus:ring-3 focus:ring-emerald-100 transition-all"
                      data-testid="register-upi-input"
                    />
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 bg-slate-50/80 border border-slate-200 rounded-2xl text-sm text-slate-900 focus:outline-hidden focus:border-emerald-600 focus:bg-white focus:ring-3 focus:ring-emerald-100 transition-all font-medium"
                  >
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white font-bold py-3.5 px-4 rounded-2xl text-sm shadow-lg shadow-emerald-600/20 transition-all flex items-center justify-center space-x-2 disabled:opacity-50 mt-2"
